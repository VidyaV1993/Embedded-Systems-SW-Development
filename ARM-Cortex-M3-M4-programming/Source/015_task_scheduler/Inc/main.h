...
/* some stack memory calculations based on the stack assessment diagram - see lecture 76: stack pointer selection */
#define SIZE_TASK_STACK          1024U //1KB
#define SIZE_SCHED_STACK         1024U //1KB

#define SRAM_START               0x20000000U
#define SIZE_SRAM                ( (128) * (1024)) //128 KB
...
//See PRIMASK reg in generic user guide to enable and disable interrupts
