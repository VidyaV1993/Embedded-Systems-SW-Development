 ...
 * @brief          : Exception entry and exit sequence demo
 ******************************************************************************
 */

/*
 * Same program as operation_modes. Demonstrates stacking and un-stacking during exception entry/exit in thread mode and handler mode.
 */
