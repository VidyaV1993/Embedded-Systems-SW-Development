...
#define FLASH_BASEADDR						0x08000000U   		/*!<Refer Table 5 in RM - Section 3  */
#define SRAM1_BASEADDR						0x20000000U  		/*!<Refer Table 5 in RM - Section 3  */
#define SRAM2_BASEADDR						0x2001C000U 		/*!<Refer Table 5 in RM - Section 3  */
#define ROM_BASEADDR						0x1FFF0000U			/*!<Refer Table 5 in RM - Section 3. S/m memory is ROM  */
#define SRAM 								SRAM1_BASEADDR


/*
 * AHBx and APBx Bus Peripheral base addresses - Refer 2.3 Memory Map in RM
 */
...
#define GPIOA_PCLK_EN()    	(RCC->AHB1ENR |= (1 << 0)) //Enable 0th bit
#define GPIOB_PCLK_EN()		(RCC->AHB1ENR |= (1 << 1)) //Enable 1st bit
...
#define GPIOI_PCLK_EN()		(RCC->AHB1ENR |= (1 << 8)) //Enable 8th bit
